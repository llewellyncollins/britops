  ...
  if (authLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-surface">
        <Loader2 aria-label="Loading" size={32} className="animate-spin text-primary" />
      </div>
    );
  }
    ...
    <div className="min-h-screen flex items-center justify-center bg-surface p-4">
      <div className="w-full max-w-sm space-y-6">
        ...
        <button
          ...
          disabled={loading}
          className="w-full border border-border py-2.5 rounded-lg font-medium text-sm hover:bg-gray-50 flex items-center justify-center gap-2 disabled:opacity-50"
        >
          {loading
            ? <Loader2 aria-hidden="true" size={18} className="animate-spin" />
